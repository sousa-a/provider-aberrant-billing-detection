...
**Rank:** 2 of 15 (by composite risk score)
...
| Priority | **HIGH** |
| Composite risk score | 0.964 (P100) |

## Billing metrics

| Metric | Value |
|---|---|
| Total claim lines | 130,186 |
| Total paid | $5,874,570 |
| Avg paid per line | $45.12 |
| Lines per beneficiary | 9.1 |
| Claims per beneficiary | 4.9 |
| HCPCS concentration (HHI) | 0.0674 |
| Distinct beneficiaries | 14,297 |

## Anomaly detection signals

| Signal | Value | Interpretation |
|---|---|---|
| Max |z-score| | 16.78 | Severe |
| IF anomaly score | -0.2067 | More negative = more anomalous |
| Excess billing | $103,066 | vs. peer group median |
