...
**Rank:** 12 of 15 (by composite risk score)
...
| Priority | **HIGH** |
| Composite risk score | 0.945 (P100) |

## Billing metrics

| Metric | Value |
|---|---|
| Total claim lines | 335,147 |
| Total paid | $14,969,520 |
| Avg paid per line | $44.67 |
| Lines per beneficiary | 4.0 |
| Claims per beneficiary | 2.1 |
| HCPCS concentration (HHI) | 0.0682 |
| Distinct beneficiaries | 84,765 |
...
| IF anomaly score | -0.1511 | More negative = more anomalous |
| Excess billing | $111,529 | vs. peer group median |
