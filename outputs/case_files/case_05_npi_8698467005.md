...
**Rank:** 5 of 15 (by composite risk score)
...
| Priority | **HIGH** |
| Composite risk score | 0.958 (P100) |

## Billing metrics

| Metric | Value |
|---|---|
| Total claim lines | 102,232 |
| Total paid | $4,617,600 |
| Avg paid per line | $45.17 |
| Lines per beneficiary | 5.9 |
| Claims per beneficiary | 3.2 |
| HCPCS concentration (HHI) | 0.0665 |
| Distinct beneficiaries | 17,315 |

## Anomaly detection signals

| Signal | Value | Interpretation |
|---|---|---|
| Max |z-score| | 9.22 | Severe |
| IF anomaly score | -0.1982 | More negative = more anomalous |
| Excess billing | $85,374 | vs. peer group median |
