...
**Rank:** 9 of 15 (by composite risk score)
...
| Metric | Value |
|---|---|
| Total claim lines | 217,344 |
| Total paid | $9,729,380 |
| Avg paid per line | $44.76 |
| Lines per beneficiary | 4.9 |
| Claims per beneficiary | 2.6 |
| HCPCS concentration (HHI) | 0.0678 |
| Distinct beneficiaries | 44,712 |

## Anomaly detection signals

| Signal | Value | Interpretation |
|---|---|---|
| Max |z-score| | 7.51 | Severe |
| IF anomaly score | -0.1846 | More negative = more anomalous |
| Excess billing | $93,921 | vs. peer group median |
