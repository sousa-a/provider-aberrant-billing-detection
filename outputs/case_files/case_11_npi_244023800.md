...
**Rank:** 11 of 15 (by composite risk score)
...
| Metric | Value |
|---|---|
| Total claim lines | 108,690 |
| Total paid | $4,893,170 |
| Avg paid per line | $45.02 |
| Lines per beneficiary | 4.5 |
| Claims per beneficiary | 2.4 |
| HCPCS concentration (HHI) | 0.0678 |
| Distinct beneficiaries | 24,090 |

## Anomaly detection signals

| Signal | Value | Interpretation |
|---|---|---|
| Max |z-score| | 6.75 | Severe |
| IF anomaly score | -0.1767 | More negative = more anomalous |
| Excess billing | $74,643 | vs. peer group median |
