...
**Rank:** 8 of 15 (by composite risk score)
...
| Metric | Value |
|---|---|
| Total claim lines | 231,411 |
| Total paid | $10,316,580 |
| Avg paid per line | $44.58 |
| Lines per beneficiary | 5.1 |
| Claims per beneficiary | 2.7 |
| HCPCS concentration (HHI) | 0.0673 |
| Distinct beneficiaries | 45,052 |

## Anomaly detection signals

| Signal | Value | Interpretation |
|---|---|---|
| Max |z-score| | 7.57 | Severe |
| IF anomaly score | -0.1853 | More negative = more anomalous |
| Excess billing | $57,492 | vs. peer group median |
