...
**Rank:** 4 of 15 (by composite risk score)
...
| Priority | **HIGH** |
| Composite risk score | 0.959 (P100) |

## Billing metrics

| Metric | Value |
|---|---|
| Total claim lines | 325,738 |
| Total paid | $14,515,770 |
| Avg paid per line | $44.56 |
| Lines per beneficiary | 6.2 |
| Claims per beneficiary | 3.3 |
| HCPCS concentration (HHI) | 0.0677 |
| Distinct beneficiaries | 52,239 |

## Anomaly detection signals

| Signal | Value | Interpretation |
|---|---|---|
| Max |z-score| | 9.92 | Severe |
| IF anomaly score | -0.1983 | More negative = more anomalous |
| Excess billing | $74,906 | vs. peer group median |
