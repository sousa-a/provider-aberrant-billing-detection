...
**Rank:** 10 of 15 (by composite risk score)
...
| Priority | **HIGH** |
| Composite risk score | 0.948 (P100) |

## Billing metrics

| Metric | Value |
|---|---|
| Total claim lines | 135,732 |
| Total paid | $6,092,400 |
| Avg paid per line | $44.89 |
| Lines per beneficiary | 4.4 |
| Claims per beneficiary | 2.3 |
| HCPCS concentration (HHI) | 0.0672 |
| Distinct beneficiaries | 31,108 |

## Anomaly detection signals

| Signal | Value | Interpretation |
|---|---|---|
| Max |z-score| | 6.99 | Severe |
| IF anomaly score | -0.1728 | More negative = more anomalous |
| Excess billing | $75,026 | vs. peer group median |
